...
#SBATCH --job-name=submit_mpid_dlreco_mcc9_v13_overlay_dirt_run1
...
LIST_OF_LISTS=/cluster/kappa/90-days-archive/wongjiradlab/moon/1L1PSelection/filelists/mpid_input/dlreco_mcc9_v13_overlay_dirt_run1.txt
