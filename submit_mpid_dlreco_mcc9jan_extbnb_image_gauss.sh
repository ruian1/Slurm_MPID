...
#SBATCH --job-name=submit_mpid_dlreco_mcc9jan_extbnb
...
LIST_OF_LISTS=/cluster/kappa/90-days-archive/wongjiradlab/moon/1L1PSelection/filelists/mpid_input/dlreco_mcc9jan_extbnb.txt
