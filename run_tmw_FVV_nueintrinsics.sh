...
# files to run
FILELIST=$SELECT_DIR/filelists/dlreco_mcc9_v13_nueintrinsics_overlay_run1.txt
...
jobdir=$workdir/selection_1l1p_$SLURM_ARRAY_TASK_ID
mkdir -p $jobdir
cd $jobdir
